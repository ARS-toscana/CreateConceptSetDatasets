...
concept_sets_of_our_study <- c("INSULIN","DIABETES","OTHER_AED", "DIABETES_free_text")
...
concept_set_domains[["DIABETES_free_text"]]="Diagnosis_free_text"
...
concept_set_codes_our_study[["DIABETES_free_text"]][["free_text"]]=c("correct free text")
