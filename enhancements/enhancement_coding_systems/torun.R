...
ConcePTION_CDM_tables[["Diagnosis"]] <- c("EVENTS")

ConcePTION_CDM_codvar <- vector(mode="list")
ConcePTION_CDM_codvar[["Diagnosis"]][["EVENTS"]]="event_code"

ConcePTION_CDM_coding_system_cols<- vector(mode="list")
ConcePTION_CDM_coding_system_cols[["Diagnosis"]][["EVENTS"]] = "event_record_vocabulary"
...
concept_set_codes_our_study[["A"]][["READ"]] <- c("F27.b")
